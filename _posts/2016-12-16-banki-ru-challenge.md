...
В таблице, которую подготовила Лаборатория, данные с точностью до года, на Банках.ру — до дня. Хочется скачать ежедневную статистику и сравнить.

Ищу данные на странице. Смотрю, что грузится при запросе.<!--break-->
...
Решаю визуализировать буду только высшую лигу, то есть 50 банков с наибольшим количеством зачтенных отзывов за последние 365 дней. Потому что в таблице, подготовленной Лабораторией, именно они.
...
Смотрю таблицу, подготовленную Лабораторией. Среднее значение оценок продуктов не совпадает с общей оценкой банка. Может ошибка в данных? [В методике расчёта рейтинга banki.ru](http://www.banki.ru/static/bundles/Ratings/BaseRating/nr_methodology.doc) о продуктах не говорится. Иду на сайт и пишу тестовый отзыв. 
