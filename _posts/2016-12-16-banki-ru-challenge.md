...
Средняя оценка банка не может быть надёжным критерием при выборе. Например, у Земского Банка твёрдая пятёрка, но всего три отзыва. Если выбирать между Тинькофф Банком и НС Банком, то лучше остановиться на Тинькоффе, хоть и оценка у него ниже:

![baki-compare-modulbank.png]({{site.baseurl}}/media/baki-compare-modulbank.png) ![banki-compare-tinkoff.png]({{site.baseurl}}/media/banki-compare-tinkoff.png)
