...
В исходной таблице нет данных об оценках за разные услуги, поэтому [в предлагаемой таблице](https://docs.google.com/spreadsheets/d/1s6NB3kfwEJhiFY2ihUpFY4wc-19JUZiQX0M_O3e9oHE/edit) они генерируются случайным образом: 
```
