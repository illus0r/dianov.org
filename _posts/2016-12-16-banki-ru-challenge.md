...
Если бы не дедлайн, я бы хотел:

* спарсить [отзывы](http://www.banki.ru/services/responses/list/) и заменить данные о продуктах на настоящие.
* Показать, сколько и каких оценок банк получил в каждый момент времени. Например, раскрасить червяков: красный пиксель — 1 балл, зелёный — 5.
* Проверить правильность рейтинга Банков.ру, пересчитать оценки в рейтинг по их формуле.
* Сделать рейтинги по продуктам.

Показал бы, как банки разъединяются и поглощают друг друга.
