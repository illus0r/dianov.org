...
layout: post
published: true
title: Визуализация народных оценок Банков.ру
...
Ещё вывод: я заинтересовался Тинькофф Банком, хочу узнать о нём побольше.
...
* заменить случайные значения оценок продуктов на настоящие, [я их нашёл](http://www.banki.ru/services/responses/list/), скачал, но ещё не распарсил.
