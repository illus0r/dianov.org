...
Можно выбрать оценку от 1 до 5 и любое количество оцениваемых продуктов. Значит, я могу менять общую оценку, не меняя оценки отдельных продуктов. Оценки продуктов нельзя складывать между собой, стримграф будет бессмысленным. Нарисую линиями:
