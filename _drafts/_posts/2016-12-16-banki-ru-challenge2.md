...
Видим, что в периоды, за которые данных нет, сайт работал и банки получали отзывы. Жалко, в данных нет их текстов, можно было бы показать настроение или проверить уникальность.</span>
