...
Из подкаста [Дата Сториз](datastori.es) <span style="letter-spacing: 0.01em;">узнал про</span> [Табло](http://www.tableau.com/)<span style="letter-spacing: 0.01em;">, пробую визуализировать в нём. Инструмент клёвый для быстрого просмотра данных и пробных визуализаций, но часто натыкаюсь на вещи, которые не знаю, как сделать.</span>

<span style="letter-spacing: 0.01em;">Вот, например, взаимозависимость количества оценок по разным услуга. Каждая точка — банк в момент времени. Видно, что по перекредитованию отзывов меньше, чем по другим услугам.</span>
...
Скачиваю новые данные и «заклеиваю» разрывы.
